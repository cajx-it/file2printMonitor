...
import application.controller.RejectController;
...
public class reject_rows {

    public static VBox build(String str, String path) {

        // -- DOT INDICATOR --
        Label dot = new Label("●");
        dot.setStyle("-fx-text-fill: #FF1900; -fx-font-size: 8px;");
        ...
        // -- PENDING BADGE --
        Label badge = new Label("REJECTED");
        badge.setStyle(
            "-fx-text-fill: #FF1900;" +
            "-fx-font-size: 9px;" +
            "-fx-font-family: 'Courier New';" +
        ...
        openBtn.setId("open");
        openBtn.setOnMouseClicked(event -> RejectController.OpenFolder(event));
        ...
        deletetBtn.setOnMouseClicked(event -> RejectController.DeleteFolder(event));
